...
try {
  ...
  /// Destructuring (bonus) ///
	...
	(function UseObjectDestructuring2() {
        ...
        const [a, b, c] = [obj.name, obj.age, obj.add];
	...
	(function UseNestedDestructuring() {
        ...
        const [a, b, c] = [obj.add, obj.city.name, obj.arr.slice(1)];
